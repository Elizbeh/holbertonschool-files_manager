...
-   [Node JS getting started](https://intranet.hbtn.io/rltoken/iOS_zcJZzRYatxV3Y1EXjA "Node JS getting started")
...
-   [Redis](https://intranet.hbtn.io/rltoken/FdBM1wERwywvDKROw8bWgg "Redis")
...
-   Otherwise:
    -   By using the module  `mime-types`, get the  [MIME-type](https://intranet.hbtn.io/rltoken/JQ1NLDt7urWei63kd1hAmw "MIME-type")  based on the  `name`  of the file
